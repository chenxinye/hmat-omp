#ifndef HODLR_ROUTINES_H
#define HODLR_ROUTINES_H
...
public:
    ...
    HODLRMatrix(double tol = 1e-6) : root(nullptr), N(0), tolerance(tol), rsvd_rank(64) {}
    ~HODLRMatrix() { for(auto n : nodes) delete n; }
